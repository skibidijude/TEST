...
local FileName = "RevineHub_v1.json" 
-- Theme Colors: Purple and White
local Theme = {
    Background      = Color3.fromRGB(15, 12, 25),   -- Dark purple-black
    Surface         = Color3.fromRGB(25, 20, 40),   -- Deep purple
    SurfaceHighlight= Color3.fromRGB(40, 30, 60),   -- Lighter purple
    Accent1         = Color3.fromRGB(156, 110, 255), -- Vibrant purple
    Accent2         = Color3.fromRGB(210, 170, 255), -- Soft lavender
    TextPrimary     = Color3.fromRGB(255, 255, 255), -- White
    TextSecondary   = Color3.fromRGB(200, 190, 220), -- Off-white purple tint
    Success         = Color3.fromRGB(156, 110, 255), -- Purple success
    Error           = Color3.fromRGB(255, 80, 120),   -- Soft red for errors
}
...
local function kickPlayer()
    LocalPlayer:Kick("\ndiscord.gg/revinehub - made by Silver & .7uxp")
end
...
task.spawn(function()
    ...
    local HTheme = {
        ...
        Accent1 = Color3.fromRGB(156, 110, 255), -- Purple
        Accent2 = Color3.fromRGB(210, 170, 255), -- Lavender
    ...
    if privateBuild then
        title.Text = "REVINE HUB PRIVATE"
    else
        title.Text = "REVINE HUB"
    end
    title.Font = Enum.Font.GothamBlack
    ...
    if privateBuild then
        ...
        author.Text = "made by Silver & .7uxp"
    end
...
task.spawn(function()
    local HTheme = {
        Background = Color3.fromRGB(15,17,22),
        Accent1 = Color3.fromRGB(156, 110, 255),
        Accent2 = Color3.fromRGB(210, 170, 255),
        White   = Color3.fromRGB(235,235,245),
        Gray    = Color3.fromRGB(130,130,145),
        Success = Color3.fromRGB(156, 110, 255),
